...
class Actor(nn.Module):
    ...
    def get_action(self, x):
        ...
        if len(action.shape) < 2 or action.shape[0]==14: 
...
class SAC_Agent(AgentBase, nn.Module):
    ...
    def __init__(self, env_info, agent_id=1):
        ...
        self.action_dim = env_info["rl_info"].action_space.low.shape[0]
        self.action_dim_ = env_info["rl_info"].action_space.low.shape
